...
define('SQL_CONNECTIONSTRING', 'mysql:dbname=castlega_eyeo956;host='.SQL_HOST);
define('SQL_USERNAME', 'castlega_eyeo956');
define('SQL_PASSWORD', '7!45dXp)OS');
// NETSYNC 
define('SQL_NETSYNC_DBNAME', 'castlega_eyeo956');
...
/*
//ACTIVEMQ URL
define('ACTIVEMQ_DESTINATION_URL', 'ws://www.castlegaming.org:8001/activemq');
